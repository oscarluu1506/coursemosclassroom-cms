...
import { ChevronRight, Github, User, LogOut, Settings } from "lucide-react";
        ...
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-2.5">
            ...
            {user ? (
                ...
                // Hiển thị login button khi chưa đăng nhập
                <>
            ...
            <div className="py-4">
              {user ? (
                  <div className="space-y-3">
                    ...
                    <button
                        onClick={handleLogout}
                        className="text-red-600 block w-full py-2 text-left text-base font-medium"
                    >
                      Logout
                    </button>
                  </div>
                  ...
                  <div className="space-y-3">
                    <Link
                        href="/login"
                        className="block w-full py-2 text-center text-base font-medium"
                        onClick={() => setIsMenuOpen(false)}
                    >
